...
String c=jsonObj.scm.projects.project.repositories[0].repository[0].branches[0].startPoint[0]
String sPoint=c.replaceAll("\\[", "").replaceAll("\\]","");
String d=jsonObj.scm.projects.project.repositories[0].repository[0].branches[0].branch[0].name[2] 
